...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($ket_qua && mysqli_num_rows($ket_qua) > 0) {
        ...
        $thong_bao = "Mat khau khong chinh xac!";
    } else {
        $thong_bao = "Tai khoan khong ton tai!";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Dang nhap - Web Phim</title>
...
<body>
    <div class="login-container">
        <h2 style="margin-bottom: 25px;">Dang Nhap</h2>
        <p style="color: yellow; font-weight: bold;"><?php echo $thong_bao; ?></p>

        <form action="" method="POST">
            <input type="text" name="username" placeholder="Tai khoan" class="input-field" required>
            <input type="password" name="password" placeholder="Mat khau" class="input-field" required>
            <button type="submit" class="btn-submit">Dang nhap</button>
        </form>

        <p class="register-text">
            Chua co tai khoan? <a href="register.php" class="register-link">Dang ky ngay</a>
        </p>

        <a href="index.php" class="back-home">&larr; Quay lai Trang chu</a>
    </div>
</body>
</html>
